...
const ICON_OVERRIDES: Record<string, string> = {
  IconArrowRight:
    '<svg width="20" height="20" viewBox="0 0 20 20" class="svg-icon IconArrowRight" aria-hidden="true"><path d="m17.52 9.28.56.54-.56.54-7.25 6.93-1.04-1.08 5.97-5.71H2V9h15.24zM15.7 7.5h-2.15L9.23 3.29l1.04-1.08z"/></svg>',
};

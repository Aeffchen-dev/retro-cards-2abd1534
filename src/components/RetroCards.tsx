  ...
  const renderCard = (cardIndex: number) => {
    switch (cardIndex) {
          ...
          <div className="flex flex-col items-start w-full h-full">
            ...
            <div className="flex flex-col flex-1 justify-end" style={{ width: 'calc(100% + 56px)', marginLeft: '-28px', marginRight: '-28px' }}>
              {[
                ...
                <div
                  key={i}
                  className="retro-body-copy flex items-center justify-between gap-3"
                  style={{
                ...
                >
                  ...
                  <button
                    ...
                    style={{ touchAction: 'manipulation', backgroundColor: i % 2 === 0 ? '#5EBA7D' : '#4FC3D9' }}
      ...
      case SLIDE_SETUP: {
        ...
        const fieldStyle = { background: "#CDEDE8", color: SETUP_TEXT, border: "none" } as React.CSSProperties;
        const emojiPicker = (
          value: string,
          placeholder: string,
          ...
          <div className="flex flex-col justify-start items-start w-full h-full">
            ...
            <div className="flex flex-col w-full mt-8">
              ...
              {setupData.extraPartners.map((p, idx) => (
                <div key={idx} className="flex items-center gap-2 w-full py-4">

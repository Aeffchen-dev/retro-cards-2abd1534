        ...
        return (
          <div className="flex flex-col items-start w-full h-full">
            ...
            <button
              ...
              className="swiper-no-swiping relative z-40 mt-auto w-full flex items-center justify-center gap-3 retro-body-copy !text-[#0D0D0E] bg-[#5C8A2A] rounded-full px-6 py-3 hover:opacity-90 transition-opacity"
            >
